    ...
    <div className="checkout-container">
        ...
        {productDetails ? (
          <div className="product-card">
            {productDetails.Image && (
                    <img src={productDetails.Image} alt={productDetails.ProductId} className='product-image' />
                )}
            <p><strong>Name:</strong> {productDetails.ProductTitle}</p>
            <p><strong>Price:</strong> {productDetails.Price}</p>
            <p><strong>Color:</strong> {productDetails.Colour}</p>
      ...
      <div className="address-section">
        ...
        {editingAddress ? (
          ...
          showAddAddress && addressesAdded < 3 && (
